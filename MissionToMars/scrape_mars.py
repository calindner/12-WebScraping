...
def scrape_data():
	...
	print(str(datetime.datetime.now()) + " - Scraped News Content: " + str(news_body))
	...
	featured_image_url  = soup.find('py app.pyarticle')['style'].replace('background-image: url(','').replace(');', '')[1:-1]
